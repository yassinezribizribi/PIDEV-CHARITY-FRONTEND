...
class CountUpDirective {
    ...
    ngOnChanges(changes) {
        ...
        if (this.countUp) {
            if ((options === null || options === void 0 ? void 0 : options.currentValue) !== undefined || (endVal === null || endVal === void 0 ? void 0 : endVal.currentValue) !== undefined) {
                // If options have changed, reinitialize
                if ((options === null || options === void 0 ? void 0 : options.currentValue) !== undefined) {
                    this.initAndRun();
                }
                else {
