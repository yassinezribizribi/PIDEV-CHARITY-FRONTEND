...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(CaretLeftIcon, { className: "CaretLeftIcon", filePath: "caretleft.ts", lineNumber: 16 }); })();
