...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(AngleDownIcon, { className: "AngleDownIcon", filePath: "angledown.ts", lineNumber: 16 }); })();
