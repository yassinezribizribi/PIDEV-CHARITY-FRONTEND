...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(ArrowDownLeftIcon, { className: "ArrowDownLeftIcon", filePath: "arrowdownleft.ts", lineNumber: 16 }); })();
