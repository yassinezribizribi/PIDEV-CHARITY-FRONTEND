...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(ArrowDownRightIcon, { className: "ArrowDownRightIcon", filePath: "arrowdownright.ts", lineNumber: 16 }); })();
