...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(SearchPlusIcon, { className: "SearchPlusIcon", filePath: "searchplus.ts", lineNumber: 26 }); })();
