...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(FilterSlashIcon, { className: "FilterSlashIcon", filePath: "filterslash.ts", lineNumber: 26 }); })();
