...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(TimesCircleIcon, { className: "TimesCircleIcon", filePath: "timescircle.ts", lineNumber: 26 }); })();
