...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(TimesIcon, { className: "TimesIcon", filePath: "times.ts", lineNumber: 16 }); })();
