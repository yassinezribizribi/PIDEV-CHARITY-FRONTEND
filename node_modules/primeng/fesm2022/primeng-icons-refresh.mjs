...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(RefreshIcon, { className: "RefreshIcon", filePath: "refresh.ts", lineNumber: 26 }); })();
