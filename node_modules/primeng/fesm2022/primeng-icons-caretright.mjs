...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(CaretRightIcon, { className: "CaretRightIcon", filePath: "caretright.ts", lineNumber: 16 }); })();
