...
class Ripple extends BaseComponent {
    ...
    static ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: Ripple, selectors: [["", "pRipple", ""]], hostAttrs: [1, "p-ripple"], features: [i0.ɵɵProvidersFeature([RippleStyle]), i0.ɵɵInheritDefinitionFeature] });
}
