...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(AngleDoubleLeftIcon, { className: "AngleDoubleLeftIcon", filePath: "angledoubleleft.ts", lineNumber: 18 }); })();
