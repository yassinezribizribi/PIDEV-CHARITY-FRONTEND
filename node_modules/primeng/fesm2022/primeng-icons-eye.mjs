...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(EyeIcon, { className: "EyeIcon", filePath: "eye.ts", lineNumber: 18 }); })();
