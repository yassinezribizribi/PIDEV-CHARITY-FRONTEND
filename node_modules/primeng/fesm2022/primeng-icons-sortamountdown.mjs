...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(SortAmountDownIcon, { className: "SortAmountDownIcon", filePath: "sortamountdown.ts", lineNumber: 24 }); })();
