...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(ChevronDownIcon, { className: "ChevronDownIcon", filePath: "chevrondown.ts", lineNumber: 16 }); })();
