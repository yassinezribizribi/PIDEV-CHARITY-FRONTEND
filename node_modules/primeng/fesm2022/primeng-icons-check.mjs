...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(CheckIcon, { className: "CheckIcon", filePath: "check.ts", lineNumber: 16 }); })();
