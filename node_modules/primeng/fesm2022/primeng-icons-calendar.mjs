...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(CalendarIcon, { className: "CalendarIcon", filePath: "calendar.ts", lineNumber: 16 }); })();
