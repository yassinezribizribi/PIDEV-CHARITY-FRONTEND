...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(AngleUpIcon, { className: "AngleUpIcon", filePath: "angleup.ts", lineNumber: 16 }); })();
