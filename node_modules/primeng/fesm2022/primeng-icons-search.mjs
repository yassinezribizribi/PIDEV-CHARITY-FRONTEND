...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(SearchIcon, { className: "SearchIcon", filePath: "search.ts", lineNumber: 26 }); })();
