...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(AngleDoubleRightIcon, { className: "AngleDoubleRightIcon", filePath: "angledoubleright.ts", lineNumber: 18 }); })();
