...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(SortAmountUpAltIcon, { className: "SortAmountUpAltIcon", filePath: "sortamountupalt.ts", lineNumber: 24 }); })();
