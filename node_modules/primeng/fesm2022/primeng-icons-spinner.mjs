...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(SpinnerIcon, { className: "SpinnerIcon", filePath: "spinner.ts", lineNumber: 24 }); })();
