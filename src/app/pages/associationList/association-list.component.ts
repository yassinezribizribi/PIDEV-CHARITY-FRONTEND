    ...
    template: `
        ...
        <section class="section pt-4">
            <div class="container">
                ...
                <!-- No Results -->
                <div *ngIf="!loading && !error && filteredAssociations.length === 0" class="text-center py-5">
                ...
                <!-- Association Cards -->
                <div class="row g-4">
                    <div *ngFor="let association of filteredAssociations" class="col-lg-4 col-md-6 col-12">
                        <div class="card position-relative overflow-hidden shadow rounded-3 border-0 hover-translate-y">
                            ...
                            <div class="association-image position-relative overflow-hidden">
                                <img [src]="images[association.idAssociation] || '/assets/images/default-logo.png'"
...
export class AssociationListComponent implements OnInit {
    ...
    private loadImage(id: string, filename: string): void {
        this.associationService.getAssociationLogo(filename).subscribe({
            ...
            error: (err) => {
                ...
                this.images[id] = '/assets/images/default-logo.png';
            }
        });
    }
    ...
    applyFilters() {
        this.filteredAssociations = this.associations.filter(association => {
            const matchesSearch = !this.searchTerm || 
                association.associationName.toLowerCase().includes(this.searchTerm.toLowerCase()) ||
                association.description.toLowerCase().includes(this.searchTerm.toLowerCase());

            const matchesLocation = !this.selectedLocation || 
                association.associationAddress.includes(this.selectedLocation);

            const matchesTier = !this.selectedTier || 
                association.partnershipTier === this.selectedTier;
    ...
    subscribe(association: Association) {
        ...
        console.log('Subscribing to:', association.associationName);
    }
} 